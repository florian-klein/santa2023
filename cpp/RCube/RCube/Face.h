...
class Face {
  ...
  byte *data;      // face data
  int orientation; // Virtual orientation of this face [0,1,2,3] - 90 degree
                   // clockwise rotations
  uint PieceCount[6]; // Keep track of the number of each piece on this face
                      // (used for validating the integrity of the cube)
...
// Virtually rotates this face by q * 90 degrees (this does not affect other
// cube faces!)
...
// Gets the value of this face at coordinates r,c + an additional rotation q
// (q=90 cw turn)
